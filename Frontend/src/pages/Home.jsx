    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 text-slate-800">
      ...
      <section className="pt-28 pb-16 px-4 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-700 to-indigo-700 text-transparent bg-clip-text mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link
              to="/register"
              className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-6 py-3 rounded text-lg transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Start Analyzing
            ...
            <Link
              to="/login"
              className="border border-gray-300 px-6 py-3 rounded text-lg text-gray-700 hover:bg-gray-100 transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
            >
              Sign In
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-white border border-slate-200 rounded-xl p-6 text-left shadow hover:shadow-lg transition transform hover:-translate-y-1"
              >
                <div className="mb-4 p-2 bg-gradient-to-br from-blue-500 to-indigo-500 text-white w-fit rounded-lg">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-blue-600 to-indigo-700 text-white text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <Link
            to="/register"
            className="bg-white text-blue-700 px-6 py-3 rounded-lg text-lg font-medium hover:bg-slate-100 transition"
          >
            Get Started Free
          </Link>
        </div>
